			...
			<div class="col-lg-12 mt-4">
				<div class="panel">
			      <div class="panel-heading" style="font-size: 19px;">Your Devices:
			      	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#new-device" style="font-size: 18px; float: right; margin-top: -6px; background-color:#226dc9 ; border-color:#226dc9 ; color:white">New Device</button>
			      </div>
		    ...
		    <div class="modal-content">
		      ...
		      <form action="" method="POST" enctype="multipart/form-data">
			      <div class="modal-body">
			      	...
			      	<label for="User-mail"><b>Device Room:</b></label>
			      	<input type="text" name="dev_dep" id="dev_dep" placeholder="Device Room..." required/><br>
			      </div>
