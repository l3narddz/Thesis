    ...
    <div class="modal-content">
      ...
      <form action="ac_update.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-body">
	      	...
	      	<label for="User-mail"><b>Admin Username:</b></label>
	      	<input type="email" name="up_email" placeholder="Enter Username..." value="<?php echo $_SESSION['Admin-email']; ?>" required/><br>
	      	<label for="User-psw"><b>Password</b></label>
	      	<input type="password" name="up_pwd" placeholder="Enter Password..." required/><br>
	      </div>
